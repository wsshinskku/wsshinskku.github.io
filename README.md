...
- `_data/research.yml` groups the research frameworks and stores summaries, topics, detail URLs, and repository access. Each `publication_title` must exactly match a title in `publications.yml` so metadata stays synchronized.
